...
import { ReservationsTab } from "interfaces/reservations";

import { reservationsPageTabs } from "utils/reservations";

import { MAIN_THEME } from "styles/colors";
import { FONT_FAMILY_BOLD } from "styles/typography";

interface Props {
	curentTab: ReservationsTab;
	changeActiveTab: (tab: ReservationsTab) => void;
}
...
const PropertiesDetailsTabs = (props: Props): JSX.Element => {
	...
	const renderTabs = () =>
		reservationsPageTabs.map((tab: ReservationsTab) => {
